...
typedef OnTapPerson = void Function(Person person);

class PersonsListWidget extends StatefulWidget {
  final List<Person> _persons;
  final OnTapPerson? onTap;

  PersonsListWidget(this._persons, {Key? key, this.onTap = null}) : super(key: key);
    ...
    return ListView.separated(
        ...
        itemBuilder: (BuildContext context, int index) {
          ...
          return GestureDetector(
            onTap: () => widget.onTap?.call(widget._persons[index]),
            child: Padding(
