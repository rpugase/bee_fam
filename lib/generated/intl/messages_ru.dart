...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "all_reminders": MessageLookupByLibrary.simpleMessage("Все Напоминания"),
    ...
    "error_name_require": MessageLookupByLibrary.simpleMessage("Введите имя"),
    ...
    "from_contacts": MessageLookupByLibrary.simpleMessage("Импорт с Контактов"),
    "from_google_calendar": MessageLookupByLibrary.simpleMessage(
      "Импорт с Google Календаря",
    ),
    ...
    "in_day_birthday": MessageLookupByLibrary.simpleMessage("В день события"),
    "in_x_month": m1,
    "in_x_week": m2,
